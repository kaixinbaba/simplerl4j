...
import static org.rl.simple.common.enums.Algorithm.SARSA_EXPECTED;

@SuppressWarnings("all")
public class TestMazeEnvBySarsaExpected {
    ...
    public static void main(String[] args) {
        ...
        Agent agent = AgentFactory.get(SARSA_EXPECTED, maze);
        int maxEpisode = 100;
        int episode = 0;
